...
public class MoveGeneratorHelper {
    ...
    public static void verifyPieceMoveGeneration(Position position, byte piece, int rank, int file, List<String> expectedFenStrings) {
        ...
        MoveGeneratorHelper.compareFenStringsToPosition(expectedFenStrings, actualFollowUps);
        //compare mirrored expected positions and actual follow-ups for mirrored position
        MoveGeneratorHelper.mirrorFenStringsAndCompareToPosition(expectedFenStrings, actualMirroredPositionFollowUps);
    }
     ...
     */
    public static void mirrorExpectedAndComparePositions(List<Position> expectedFollowUps, List<Position> actualMirroredPositionFollowUps) {
        //mirror expected
     ...
     * @param actualMirroredPositionFollowUps the follow-ups generated by MoveGenerator for the mirrored Position
     */
    public static void mirrorFenStringsAndCompareToPosition(Collection<String> fenStrings, Collection<Position> actualMirroredPositionFollowUps) {
        mirrorExpectedAndComparePositions(MoveGeneratorHelper.fenStringsToPositions(fenStrings), MoveGeneratorHelper.toList(actualMirroredPositionFollowUps));
    }
