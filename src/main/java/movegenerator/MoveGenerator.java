...
public abstract class MoveGenerator {
     ...
     * @param rank starting rank of the piece //TODO describe when board orientation is settled
     * @param file starting file of the piece //TODO describe when board orientation is settled
    ...
    private Set<Board> computeRay(Board currentBoard, int rank, int file, int xOffset, int yOffset) {
        ...
        while (targetLegal(rank, file, piece.getIsWhite(), currentBoard)) {
            Piece spaces[][] = currentBoard.copySpaces();
            //leave current space
            ...
            generatedBoard = new Board(spaces, !currentBoard.getWhiteNextMove(), whiteCastlingKingside, whiteCastlingQueenside, blackCastlingKingside, blackCastlingQueenside, -1, -1, halfMoves, fullMoves)
